...
`;class ue extends se{constructor(){super(...arguments),this._expanded=!1,this._openPanel=null,this._ghDropdown=null,this._handleWindowClick=e=>{const t=e.composedPath();!this._ghDropdown&&!this._openPanel||t.includes(this)||(this._ghDropdown=null,this._openPanel=null)}}connectedCallback(){super.connectedCallback(),window.addEventListener("click",this._handleWindowClick)}disconnectedCallback(){window.removeEventListener("click",this._handleWindowClick),super.disconnectedCallback()}static get styles(){return he}setConfig(e){if(!e)throw new Error("Please define a valid configuration");this._config={theme:"default",layout:"default",...e}}updated(e){if(super.updated(e),e.has("_config")){const e=this._config?.theme||"default";"default"===e?this.removeAttribute("theme"):this.setAttribute("theme",e),this._config?.accent_color?this.style.setProperty("--appliance-accent",this._config.accent_color):this.style.removeProperty("--appliance-accent"),this._config?.main_color?this.style.setProperty("--appliance-bg",this._config.main_color):this.style.removeProperty("--appliance-bg")}}getCardSize(){return"compact"!==this._config?.layout||this._expanded?5:2}static getConfigForm(){return{schema:[{name:"entity",required:!0,label:"Washer Entity",selector:{entity:{domain:["select","switch"]}}},{name:"name",label:"Custom Title",selector:{text:{}}},{name:"theme",label:"Theme",selector:{select:{options:[{label:"Default HA Theme",value:"default"},{label:"Material You",value:"material_you"}]}}},{name:"layout",label:"Card Layout",selector:{select:{options:[{label:"Default (Full)",value:"default"},{label:"Compact (Expandable)",value:"compact"}]}}},{name:"full_layout",label:"Full View Style",selector:{select:{options:[{label:"Classic",value:"default"},{label:"Google Home",value:"google_home"}]}}},{name:"",type:"expandable",title:"Display Sensors (Auto-Discovered if blank)",icon:"mdi:thermometer",schema:[{name:"tub_temp_sensor",label:"Tub Temperature Sensor",selector:{entity:{domain:"sensor"}}},{name:"motor_speed_sensor",label:"Motor Speed Sensor",selector:{entity:{domain:"sensor"}}},{name:"time_remaining_sensor",label:"Time Remaining Sensor",selector:{entity:{domain:"sensor"}}},{name:"cycle_progress_sensor",label:"Cycle Progress Sensor",selector:{entity:{domain:"sensor"}}},{name:"door_locked_sensor",label:"Door Locked Sensor",selector:{entity:{domain:"binary_sensor"}}},{name:"machine_state_sensor",label:"Machine State Sensor",selector:{entity:{domain:"sensor"}}},{name:"program_duration_sensor",label:"Program Duration Sensor",selector:{entity:{domain:"sensor"}}}]},{name:"",type:"expandable",title:"Companion Controls (Auto-Discovered if blank)",icon:"mdi:toggle-switch-outline",schema:[{name:"power_switch",label:"Power Switch",selector:{entity:{domain:"switch"}}},{name:"program_select",label:"Program Select",selector:{entity:{domain:"select"}}},{name:"spin_select",label:"Spin Speed Select",selector:{entity:{domain:"select"}}},{name:"temperature_select",label:"Temperature Select",selector:{entity:{domain:"select"}}},{name:"delay_select",label:"Delay Start Select",selector:{entity:{domain:"select"}}},{name:"start_button",label:"Start Button",selector:{entity:{domain:"button"}}},{name:"pause_button",label:"Pause Button",selector:{entity:{domain:"button"}}},{name:"cancel_button",label:"Cancel Button",selector:{entity:{domain:"button"}}},{name:"child_lock_switch",label:"Child Lock Switch",selector:{entity:{domain:"switch"}}}]},{name:"",type:"expandable",title:"Theming & Colors",icon:"mdi:palette",schema:[{name:"accent_color",label:"Accent Color Override",selector:{ui_color:{}}},{name:"main_color",label:"Background Color Override",selector:{ui_color:{}}}]}]}}static getStubConfig(e,t,i){let o="";return t&&t.length&&(o=t.find(e=>e.startsWith("select.")&&(e.includes("program")||e.includes("ifb_washer")))||t.find(e=>e.startsWith("switch.")&&(e.includes("power")||e.includes("ifb_washer")))||t.find(e=>e.includes("ifb_washer"))||""),!o&&i&&i.length&&(o=i.find(e=>e.includes("ifb_washer"))||""),!o&&e?.states&&(o=Object.keys(e.states).find(e=>e.startsWith("select.")&&(e.includes("program")||e.includes("ifb_washer")))||Object.keys(e.states).find(e=>e.startsWith("switch.")&&(e.includes("power")||e.includes("ifb_washer")))||Object.keys(e.states).find(e=>e.includes("ifb_washer"))||""),{type:"custom:ifb-washer-card",entity:o}}_haptic(e="light"){window.dispatchEvent(new CustomEvent("haptic",{detail:e}))}_showToast(e){this._haptic("warning"),this.dispatchEvent(new CustomEvent("hass-notification",{bubbles:!0,composed:!0,detail:{message:e}}))}_resolveEntities(){const e=this._config?.entity||"",t=this._config||{};let i=t.power_switch,o=t.start_button,a=t.pause_button,n=t.cancel_button,s=t.program_select,r=t.spin_select,c=t.temperature_select,l=t.delay_select,p=t.child_lock_switch,d=t.machine_state_sensor,h=t.time_remaining_sensor,u=t.cycle_progress_sensor,g=t.tub_temp_sensor,m=t.motor_speed_sensor,f=t.door_locked_sensor,v="";if(!e)return{power:i||"",start:o||"",pause:a||"",cancel:n||"",program:s||"",spin:r||"",temp:c||"",delay:l||"",childLock:p||"",state:d||"",remaining:h||"",progress:u||"",tubTemp:g||"",rpm:m||"",door:f||"",problem:""};const b=this.hass?.entities;if(b&&b[e]){const t=b[e].device_id;if(t)for(const[e,_]of Object.entries(b)){if(_.device_id!==t)continue;const b=_.unique_id||"",y=_.translation_key||"";i||!b.endsWith("_power_switch")&&"power"!==y||(i=e),o||!b.endsWith("_start")&&"start"!==y||(o=e),a||!b.endsWith("_pause")&&"pause"!==y||(a=e),n||!b.endsWith("_cancel")&&"cancel"!==y||(n=e),s||!b.endsWith("_program_select")&&"program_select"!==y||(s=e),r||!b.endsWith("_spin_speed_select")&&"spin_speed_select"!==y||(r=e),c||!b.endsWith("_temperature_select")&&"temperature_select"!==y||(c=e),l||!b.endsWith("_delay_start_select")&&"delay_start_select"!==y||(l=e),p||!b.endsWith("_child_lock_switch")&&"child_lock_switch"!==y||(p=e),d||!b.endsWith("_state")&&"machine_state"!==y||(d=e),h||!b.endsWith("_time_remaining")&&"time_remaining"!==y||(h=e),u||!b.endsWith("_cycle_progress")&&"cycle_progress"!==y||(u=e),g||!b.endsWith("_tub_temperature")&&"tub_temperature"!==y||(g=e),m||!b.endsWith("_motor_rpm")&&"motor_rpm"!==y&&!b.endsWith("_motor_speed")||(m=e),f||!b.endsWith("_door_locked")&&"door_locked"!==y||(f=e),v||!b.endsWith("_problem")&&"problem"!==y||(v=e)}}const _=["_power","_power_switch","_machine_state","_running","_time_remaining","_program_duration","_cycle_progress","_start","_pause","_cancel","_program_select","_spin_speed_select","_temperature_select","_delay_start_select","_child_lock_switch","_tub_temperature","_motor_speed","_door_locked"];let y=e.split(".")[1]||"";for(const e of _)if(y.endsWith(e)){y=y.substring(0,y.length-e.length);break}return{power:i||`switch.${y}_power`,start:o||`button.${y}_start`,pause:a||`button.${y}_pause`,cancel:n||`button.${y}_cancel`,program:s||`select.${y}_program_select`,spin:r||`select.${y}_spin_speed_select`,temp:c||`select.${y}_temperature_select`,delay:l||`select.${y}_delay_start_select`,childLock:p||`switch.${y}_child_lock_switch`,state:d||`sensor.${y}_machine_state`,remaining:h||`sensor.${y}_time_remaining`,progress:u||`sensor.${y}_cycle_progress`,tubTemp:g||`sensor.${y}_tub_temperature`,rpm:m||`sensor.${y}_motor_speed`,door:f||`binary_sensor.${y}_door_locked`,problem:v||`binary_sensor.${y}_problem`}}_callService(e,t,i){this.hass&&this.hass.callService(e,t,i)}_togglePower(e,t){t?(this._haptic("medium"),this._callService("switch","toggle",{entity_id:e.power})):this._showToast("Device is offline")}_triggerButton(e,t,i){t?i?(this._haptic("light"),this._callService("button","press",{entity_id:e})):this._showToast("Turn on the washer to start cycle"):this._showToast("Device is offline")}_selectOption(e,t,i,o,a,n=!1){i?o?a&&n?this._showToast("Pause cycle to change wash program"):(this._haptic("selection"),this._callService("select","select_option",{entity_id:e,option:t})):this._showToast("Turn on the washer to adjust settings"):this._showToast("Device is offline")}_toggleChildLock(e,t,i){t?i?(this._haptic("medium"),this._callService("switch","toggle",{entity_id:e})):this._showToast("Turn on the washer to toggle child lock"):this._showToast("Device is offline")}_formatRemaining(e){if(!e||e<=0)return"00:00";const t=e%60;return`${Math.floor(e/60).toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`}render(){if(!this.hass||!this._config)return F;if(!this._config.entity)return W`
      ...
      `;const e=this._resolveEntities(),t=this.hass.states[e.power],i=this.hass.states[e.state],o=this.hass.states[e.remaining],a=this.hass.states[e.progress],n=this.hass.states[e.program],s=this.hass.states[e.spin],r=this.hass.states[e.temp],c=this.hass.states[e.delay],l=this.hass.states[e.childLock],p=this.hass.states[e.tubTemp],d=this.hass.states[e.rpm],h=this.hass.states[e.door],u=this.hass.states[e.problem],g=Boolean(t&&"unavailable"!==t.state&&"unknown"!==t.state),m=g&&"on"===t.state,f=i?.state||(m?"Standby":"Off"),v=m&&Boolean(!["Standby","Idle","Complete","Paused","Off","unknown","unavailable"].includes(f)),b=m&&"Paused"===f,_=m&&"Complete"===f,y=o&&parseInt(o.state,10)||0,w=a?Math.min(100,Math.max(0,parseFloat(a.state)||0)):0,x=n?.state||"",$=s?.state||"",k=r?.state||"",C=c?.state||"No Delay",S="on"===l?.state,A="off"===h?.state||!0===h?.attributes?.door_locked,P="on"===u?.state,T=p&&parseInt(p.state,10)||0,D=d&&parseInt(d.state,10)||0,E=this._config.name||t?.attributes?.friendly_name?.replace(/ Power$/,"")||"IFB Washing Machine";let O="Off";if(g){if(P)O="Error / Attention Required";else if(_)O="Cycle Complete";else if(m){const e=[x||f];k&&"None"!==k&&e.push(k),$&&"None"!==$&&e.push($),O=e.join(" • ")}}else O="Offline";const z=n?.attributes?.options||[],R=s?.attributes?.options||[],j=r?.attributes?.options||[],M=c?.attributes?.options||[],H="compact"===this._config.layout;if(H&&!this._expanded)return this._renderCompactCard(e,E,O,g,m,v,b,f,y,w);if("google_home"===this._config.full_layout)return this._renderGoogleHomeFull(e,E,m,g,v,b,_,f,y,w,x,$,k,C,S,A,P,T,D,z,R,j,M);const N=2*Math.PI*70,U=N-w/100*N;return W`
      <ha-card>
        <!-- Header -->
        <div class="header">
        ...
        ${this._renderFullBody(e,g,m,v,b,_,f,y,w,70,N,U,x,$,k,C,S,A,P,T,D,z,R,j,M)}
        ...
        <div class="footer">
          ...
          •
          <div class="footer-item">
            <span class="footer-dot ${A?"red":"green"}"></span>
            <span>${A?"Door Locked":"Door Unlocked"}</span>
          </div>
          •
          <div
          ...
          >
            <ha-icon icon="${S?"mdi:account-lock":"mdi:account-lock-open-outline"}"></ha-icon>
            <span>Child Lock ${S?"On":"Off"}</span>
          </div>
          ${T>0?W`
                •
                <div class="footer-item">
